	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:if test="${not empty page.list}">
				...
				<div class="col-md-2">
				<a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${pro.pid}">
					<img src="${pageContext.request.contextPath}/${pro.pimage}" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="${pageContext.request.contextPath}/ProductServlet?method=findProductByPid&pid=${pro.pid}" style='color:green'>${pro.pname}</a></p>
